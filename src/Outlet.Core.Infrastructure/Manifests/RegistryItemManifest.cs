...
/// <summary>A file shipped by the item: source <paramref name="Path"/> + routing <paramref name="Target"/>.</summary>
public sealed record ManifestFile(string Path, string Target);
