...
/// </summary>
[Trait("Category", "Live")]
public sealed class S3BlobStorageConformanceTests : BlobStorageConformanceTests
{
    protected override async Task<IBlobStorageHarness?> CreateOrSkipAsync()
    {
        ...
        var storage = new S3BlobStorage(Options.Create(new S3BlobStorageOptions
        {
    ...
    private sealed class Harness(S3BlobStorage storage, IAmazonS3 admin, string bucket) : IBlobStorageHarness
    {
